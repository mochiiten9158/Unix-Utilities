...
int main(int argc, char *argv[]){
  ...
  22:	51                   	push   %ecx
  23:	51                   	push   %ecx
  24:	68 aa 08 00 00       	push   $0x8aa
  29:	6a 01                	push   $0x1
  2b:	e8 d0 04 00 00       	call   500 <printf>
    exit();
  30:	e8 6e 03 00 00       	call   3a3 <exit>
  }
  ...
  3c:	e8 a2 03 00 00       	call   3e3 <open>
  ...
  4b:	50                   	push   %eax
  4c:	e8 2f 00 00 00       	call   80 <encode>
    printf(1, "zip: not enough arguments\n");
  51:	53                   	push   %ebx
  52:	53                   	push   %ebx
  53:	68 8f 08 00 00       	push   $0x88f
  58:	6a 01                	push   $0x1
  ...
  68:	68 c3 08 00 00       	push   $0x8c3
  6d:	6a 01                	push   $0x1
  6f:	e8 8c 04 00 00       	call   500 <printf>
    exit();
  74:	e8 2a 03 00 00       	call   3a3 <exit>
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
void encode(int fd){
  ...
  char curr = buffer[0];
  94:	0f be 1d bc 0b 00 00 	movsbl 0xbbc,%ebx
  while((n = read(fd, buffer, 1)) > 0){
  9b:	eb 0f                	jmp    ac <encode+0x2c>
  9d:	8d 76 00             	lea    0x0(%esi),%esi
      curr = buffer[0];
  a0:	0f be 1d bc 0b 00 00 	movsbl 0xbbc,%ebx
        count = 1;
  a7:	be 01 00 00 00       	mov    $0x1,%esi
  while((n = read(fd, buffer, 1)) > 0){
  ac:	83 ec 04             	sub    $0x4,%esp
  af:	6a 01                	push   $0x1
  b1:	68 bc 0b 00 00       	push   $0xbbc
  b6:	ff 75 08             	pushl  0x8(%ebp)
  b9:	e8 fd 02 00 00       	call   3bb <read>
  be:	83 c4 10             	add    $0x10,%esp
  c1:	85 c0                	test   %eax,%eax
  c3:	7e 3b                	jle    100 <encode+0x80>
    if(run == 0){
  c5:	85 f6                	test   %esi,%esi
  c7:	74 d7                	je     a0 <encode+0x20>
      if(curr == buffer[0]){
  c9:	3a 1d bc 0b 00 00    	cmp    0xbbc,%bl
  cf:	75 0f                	jne    e0 <encode+0x60>
        count++;
  d1:	83 c7 01             	add    $0x1,%edi
  d4:	eb d1                	jmp    a7 <encode+0x27>
  ...
  e1:	57                   	push   %edi
        count = 1;
  e2:	89 f7                	mov    %esi,%edi
        printf(1, "%x %x ", count, curr);
  e4:	68 68 08 00 00       	push   $0x868
  e9:	6a 01                	push   $0x1
  eb:	e8 10 04 00 00       	call   500 <printf>
        curr = buffer[0];
  f0:	0f be 1d bc 0b 00 00 	movsbl 0xbbc,%ebx
  f7:	83 c4 10             	add    $0x10,%esp
  fa:	eb ab                	jmp    a7 <encode+0x27>
  fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  printf(1, "%x %x %x\n", count, curr, '\n');
 100:	83 ec 0c             	sub    $0xc,%esp
 103:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 106:	6a 0a                	push   $0xa
 108:	53                   	push   %ebx
 109:	57                   	push   %edi
 10a:	68 6f 08 00 00       	push   $0x86f
 10f:	6a 01                	push   $0x1
 111:	e8 ea 03 00 00       	call   500 <printf>
  if(n < 0){
 116:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 119:	83 c4 20             	add    $0x20,%esp
 11c:	85 c0                	test   %eax,%eax
 11e:	74 13                	je     133 <encode+0xb3>
    printf(1, "zip: file read error\n");
 120:	50                   	push   %eax
 121:	50                   	push   %eax
 122:	68 79 08 00 00       	push   $0x879
 127:	6a 01                	push   $0x1
 129:	e8 d2 03 00 00       	call   500 <printf>
    exit();
 12e:	e8 70 02 00 00       	call   3a3 <exit>
  exit();
 133:	e8 6b 02 00 00       	call   3a3 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb d8 08 00 00       	mov    $0x8d8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 b0 0b 00 00       	mov    0xbb0,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 b0 0b 00 00       	mov    %eax,0xbb0
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 b0 0b 00 00       	mov    0xbb0,%eax
 ...
 82e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 b0 0b 00 00 b4 	movl   $0xbb4,0xbb0
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf b4 0b 00 00       	mov    $0xbb4,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 b4 0b 00 00 b4 	movl   $0xbb4,0xbb4
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 84b:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 852:	00 00 00 
    if(p->s.size >= nunits){
