  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  5d:	68 08 06 00 00       	push   $0x608
  62:	e8 69 01 00 00       	call   1d0 <strlen>
  67:	83 c4 0c             	add    $0xc,%esp
  6a:	50                   	push   %eax
  6b:	68 08 06 00 00       	push   $0x608
  70:	6a 01                	push   $0x1
  ...
  bb:	68 3a 06 00 00       	push   $0x63a
  c0:	e8 0b 01 00 00       	call   1d0 <strlen>
  c5:	83 c4 0c             	add    $0xc,%esp
  c8:	50                   	push   %eax
  c9:	68 3a 06 00 00       	push   $0x63a
  ce:	6a 01                	push   $0x1
  ...
  e2:	68 13 06 00 00       	push   $0x613
  e7:	e8 e4 00 00 00       	call   1d0 <strlen>
  ec:	83 c4 0c             	add    $0xc,%esp
  ef:	50                   	push   %eax
  f0:	68 13 06 00 00       	push   $0x613
  f5:	6a 01                	push   $0x1
 ...
 104:	68 27 06 00 00       	push   $0x627
 109:	e8 c2 00 00 00       	call   1d0 <strlen>
 10e:	83 c4 0c             	add    $0xc,%esp
 111:	50                   	push   %eax
 112:	68 27 06 00 00       	push   $0x627
 117:	6a 01                	push   $0x1
 ...
 126:	68 48 06 00 00       	push   $0x648
 12b:	e8 a0 00 00 00       	call   1d0 <strlen>
 130:	83 c4 0c             	add    $0xc,%esp
 133:	50                   	push   %eax
 134:	68 48 06 00 00       	push   $0x648
 139:	6a 01                	push   $0x1
...
free(void *ap)
{
 ...
 475:	a1 e0 08 00 00       	mov    0x8e0,%eax
{
 ...
 496:	73 10                	jae    4a8 <free+0x38>
{
 ...
 4c1:	5b                   	pop    %ebx
  freep = p;
 4c2:	a3 e0 08 00 00       	mov    %eax,0x8e0
}
 4c7:	5e                   	pop    %esi
 4c8:	5f                   	pop    %edi
 4c9:	5d                   	pop    %ebp
 ...
 4e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 4ea:	a3 e0 08 00 00       	mov    %eax,0x8e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 50d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 510:	8b 3d e0 08 00 00    	mov    0x8e0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 559:	8b 3d e0 08 00 00    	mov    0x8e0,%edi
 ...
 56b:	e8 cb fe ff ff       	call   43b <sbrk>
  if(p == (char*)-1)
 ...
 582:	e8 e9 fe ff ff       	call   470 <free>
  return freep;
 587:	a1 e0 08 00 00       	mov    0x8e0,%eax
 ...
 5b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 5b7:	a3 e0 08 00 00       	mov    %eax,0x8e0
}
 ...
 5ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 5d0:	c7 05 e0 08 00 00 e4 	movl   $0x8e4,0x8e0
 5d7:	08 00 00 
    base.s.size = 0;
 5da:	bf e4 08 00 00       	mov    $0x8e4,%edi
    base.s.ptr = freep = prevp = &base;
 5df:	c7 05 e4 08 00 00 e4 	movl   $0x8e4,0x8e4
 5e6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 5e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 5eb:	c7 05 e8 08 00 00 00 	movl   $0x0,0x8e8
 5f2:	00 00 00 
    if(p->s.size >= nunits){
